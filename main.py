...
class MenuFrame(tk.Frame):
    ...
    def create_widgets(self):
        ...
        btn_roleta.pack(pady=20, ipadx=20, ipady=10)
        ...
        btn_caca.pack(pady=20, ipadx=20, ipady=10)
        ...
        btn_sair.pack(pady=30, ipadx=20, ipady=5)
...
class RoletaFrame(tk.Frame):
    ...
    def setup_ui(self):
        ...
        # Frame principal
        main_frame = tk.Frame(self, bg=fundo)
        main_frame.pack(expand=True, fill="both", padx=200, pady=20) # posicao botao voltar roleta
        ...
        btn_voltar.pack(pady=10, anchor="nw")
        
        # Canvas para a roleta
        self.canvas = tk.Canvas(main_frame, width=600, height=600, bg=fundo_roleta)
        self.canvas.pack(pady=20)
        
        # Configuração dos setores
        self.setores = 20
        self.angulo_por_setor = 360 / self.setores
        self.cores = ["#ff6347", "#32cd32", "#ffcc00", "#4682b4"] * (self.setores // 4)
    ...
    def desenhar_roleta(self):
        for i in range(self.setores):
            ...
            self.canvas.create_arc(
                ...
                fill=self.cores[i], outline="black"
            )
            ...
            self.canvas.create_text(
                texto_x, texto_y, text=str(self.setores_embaralhados[i]),
...
class CacaPalavrasFrame(tk.Frame):
    ...
    def setup_ui(self):
        ...
        self.selecao = []
        self.pontuacao = 0
        self.tempo_restante = 120  # 2 minutos
        self.jogando = True
        ...
        self.btn_reiniciar.grid(row=0, column=2, padx=10)
